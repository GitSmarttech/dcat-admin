                ...
                <tr>
                    ...
                    <td class="activeTd">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="help-block with-errors"></div>
                                <input type="checkbox" name="{{ $name }}[values][{{ $loop->index }}]" @if((bool)$v == 1) checked @endif  class="form-control" />
                            </div>
                        </div>
                    </td>
        ...
        <tr>
            ...
            <td class="activeTd">
                <div class="form-group  ">
                    <div class="col-sm-12">
                        <div class="help-block with-errors"></div>
                        <input type="checkbox" name="{{ $name }}[values][{key}]" class="form-control" />
                    </div>
                </div>
            </td>
